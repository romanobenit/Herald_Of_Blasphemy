export let GameData: gameData = {
  ...
  spritesheets: [
    ...
    { name: "player", path: "assets/images/PG1.png", width: 64, height: 92, frames: 2 },
    { name: "player2", path: "assets/images/PG2.png", width: 64, height: 92, frames: 2 },
    { name: "player3", path: "assets/images/PG3.png", width: 64, height: 92, frames: 2 },
    ...
    { name: "fullSfondo", path: "assets/images/sfondoMenuCompleto.png", width: 254, height: 160, frames: 2 },
    { name: "fuoco", path: "assets/images/fuoco.png", width: 254, height: 160, frames: 2 },
  ...
  images: [
    ...
    { name: "scudoFantasma", path: "assets/images/scudo.png" },
    { name: "talismano", path: "assets/images/safemask.png" },
  ],
  atlas: [],
