...
export default class Player extends Phaser.GameObjects.Sprite implements IPlayer {
    ...
    private _openInventory(
        ...
        item1.setInteractive()
            ...
            .on("pointerover", () => { this.onTwiin(item1, 3.7); descrizione.setAlpha(1).setText("Vita +100"); descrizione.x = 400; })
        ...
        item2.setInteractive()
            ...
            .on("pointerover", () => { this.onTwiin(item2, 3.7); descrizione.setAlpha(1).setText("Mana +3"); descrizione.x = 520; })
            ...
            if (this.attackBoostActive) {
                ...
                itemAttack.setInteractive()
                    ...
                    .on("pointerover", () => {
                        ...
                        descrizione.setAlpha(1).setText("Attacco x2 ");
                        descrizione.x = 760;
                    })
                    .on("pointerout", () => {
