...
export default class Boss01 extends Phaser.Scene {
  ...
  create() {
    ...
    // _Mana nascosto — serve solo per non rompere la logica interna di Player
    this._Mana = this.add
    ...
    this._restartTextLabel = this.add
      .text(1280 - 600 + 330, 800 - 70, "RESTART", { fontFamily: "Underdog", fontSize: 40, color: "#ffffff" })
      .setOrigin(0.5).setInteractive()
  ...
  private _drawManaBar(): void {
    ...
    // sfondo scuro
    this._playerManaBar
      .fillStyle(0x111133, 1)
      .fillRoundedRect(550, 580, maxWidth, 20, 10)
      .lineStyle(4, 0x000000, 1)
      .strokeRoundedRect(550, 580, maxWidth, 20, 10);

    // fill blu
    if (fillWidth > 0) {
      this._playerManaBar
        .fillStyle(0x0055ff, 1)
        .fillRoundedRect(550, 580, fillWidth, 20, 10);
    }
